...
public class Constantes {
    ...
    public static final String URL = "https://community.secop.gov.co/STS/Users/Login/Index";

    public static final String usuario = "AnaRo0612";
    ...
    public static final int TimeoutShort = 20;
